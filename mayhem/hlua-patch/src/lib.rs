...
impl<'lua> Lua<'lua> {
    ...
    pub fn open_base(&mut self) {
        unsafe { let _ = ffi::luaopen_base(self.lua.0); }
    }
    ...
    pub fn open_bit32(&mut self) {
        unsafe { let _ = ffi::luaopen_bit32(self.lua.0); }
    }
    ...
    pub fn open_coroutine(&mut self) {
        unsafe { let _ = ffi::luaopen_coroutine(self.lua.0); }
    }
    ...
    pub fn open_debug(&mut self) {
        unsafe { let _ = ffi::luaopen_debug(self.lua.0); }
    }
    ...
    pub fn open_io(&mut self) {
        unsafe { let _ = ffi::luaopen_io(self.lua.0); }
    }
    ...
    pub fn open_math(&mut self) {
        unsafe { let _ = ffi::luaopen_math(self.lua.0); }
    }
    ...
    pub fn open_os(&mut self) {
        unsafe { let _ = ffi::luaopen_os(self.lua.0); }
    }
    ...
    pub fn open_package(&mut self) {
        unsafe { let _ = ffi::luaopen_package(self.lua.0); }
    }
    ...
    pub fn open_string(&mut self) {
        unsafe { let _ = ffi::luaopen_string(self.lua.0); }
    }
    ...
    pub fn open_table(&mut self) {
        unsafe { let _ = ffi::luaopen_table(self.lua.0); }
    }
